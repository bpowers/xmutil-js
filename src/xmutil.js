var createModule = (function () {
  ...
  return function (createModule) {
    ...
    if (!Object.getOwnPropertyDescriptor(Module['ready'], '__convert_mdl_to_xmile')) {
      Object.defineProperty(Module['ready'], '__convert_mdl_to_xmile', {
        configurable: true,
        get: function () {
          abort(
            'You are getting __convert_mdl_to_xmile on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js',
          );
        },
      });
      Object.defineProperty(Module['ready'], '__convert_mdl_to_xmile', {
        ...
        set: function () {
          abort(
            'You are setting __convert_mdl_to_xmile on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js',
          );
        },
      });
    }
    ...
    var wasmBinaryFile = 'xmutil.wasm';
    ...
    /** @type {function(...*):?} */
    var __convert_mdl_to_xmile = (Module['__convert_mdl_to_xmile'] = createExportWrapper('_convert_mdl_to_xmile'));
